Es todo lo de "Resumen parcial" + Dinero + Banco Central, Política monetaria e inflación 
...
> Medio que coordina y facilita el intercambio de bienes y/o servicios en la economía.

El dinero brinda flexibilidad, ante una falta de este puede ocurrir:

- Que no se distribuyan los bienes y servicios de acuerdo con las necesidades y deseos de los individuos. Es más complejo el comercio de productos que de dinero por producto.
  
- Freno a la Especialización y el Progreso: Si tenés que pasar la mitad de tu día buscando a alguien que acepte tus productos (como en el ejemplo de las manzanas), tenés mucho menos tiempo para dedicarte a producir o a mejorar tu técnica.

## Tipos

### Mercancía

Cumplen el rol de dinero debido a su valor intrínseco (ej. la sal).

Las limitaciones que brinda esto es que se debe encontrar un bien:
...
El que conocemos y usamos, un papel moneda con respaldo gubernamental (el mercado acepta el valor de ese papel).

### Convertible

El papel esta sustentado por una cantidad de oro o plata. Por la comodidad de uso del billete nunca se realizaba la conversión a metal.

### Convertible en oro

==No entendi muy bien la diferencia con el convertible, creo que en el convertible vos depositabas oro en el banco y te daban plata a cambio. En el convertible en oro es más bien un sustento del banco (CREO)==


### Actual

No existe sustento metálico y su valor viene de al confianza de los individuos respecto a:

- Ser aceptado como medio de pago (de la gente, es costumbre)
- Curso legal (sirve para saldar deudas y obligaciones, existe una obligación por parte del receptor de aceptar esa moneda)
- Medio de pago de deudas públicas y privadas (sirve para saldar deudas y obligaciones, tiene validez para extinguir la deuda de quien paga)

Si no existe esa confianza, el billete sería de poca utilidad aunque el gobierno lo respalde: pérdida de valor del papel moneda (inflación).

## Oferta monetaria

>Cantidad de medios de pago en un momento determinado a los efectos de permitir la realización de todas las transacciones que demande el mercado.

**Representa la cantidad de dinero que circula en una economía en un momento dado.**

### Agregados monetarios

-  Variables que cuantifican el dinero de una economía. 
  
- Herramientas de los bancos centrales para determinar la política monetaria.

### Base monetaria

>Efectivo en manos del público + reservas del sistema bancario (en efectivo y las depositadas en el banco central).

- **M1 (El dinero más líquido):**
    
    - Se compone del **efectivo en manos del público** (billetes y monedas) y los **depósitos a la vista** (cuentas corrientes en los bancos, que se pueden usar inmediatamente mediante cheques o tarjetas de débito). Este es el dinero que se usa directamente para las transacciones.
        
- **M2 (M1 más cuasi-dinero):**
    
    - Incluye **M1** (efectivo y depósitos a la vista) más los **depósitos de ahorro**. Estos ya no se pueden usar de forma tan directa (como el efectivo), pero se convierten en dinero de transacción fácilmente.
        
- **M3 (M2 más otros activos):**
    
    - Incluye **M2** (M1 + depósitos de ahorro) más los **depósitos a plazo** y otros activos líquidos en manos del público. Estos tienen una liquidez menor (hay que esperar un tiempo o pagar una penalización para retirarlos).


M2 es el agregado que utilizan los bancos centrales para la definición de objetivos de crecimiento de la oferta monetaria por considerar que tiene mayor relación con la evolución de los precios domésticos.

Vamos a ver un caso que me parece copado de porque son M1 y M2 los que se toman en cuenta, está directamente asociado a la liquidez:

---

El objetivo principal de la mayoría de los Bancos Centrales es la **estabilidad de precios**.

Para controlar la inflación, el Banco Central necesita una medida de Oferta Monetaria que sea un buen **predictor** de la presión futura sobre los precios.

- Si el **M1** crece mucho, generalmente hay un impacto rápido en los precios.
    
- Si el **M2** crece mucho, es una señal de que hay mucha liquidez "dormida" en los bancos que **podría despertar** en cualquier momento, ejerciendo presión sobre la demanda agregada (mayor gasto) y, por ende, causando **inflación**.
    

Por lo tanto, al monitorear M2, el Banco Central intenta anticipar la demanda futura y ajustar su **Política Monetaria** para influir en la actividad económica antes de que el problema inflacionario se manifieste completamente.

---
## Demanda de dinero

Viene dada por la necesidad de poseer un medio de cambio para el comercio y el intercambio.

### Funciones

#### Medio de cambio

Aceptado por los individuos para la realización de transacciones económicas y cancelación de deudas.

#### Unidad de cuenta

Se fijan los precios y se nominan las cuentas. Es una medida del valor.

#### Reserva de valor

Activo financiero que sirve de depósito de valor y permite trasladarlo en el tiempo, es decir, es un medio para mantener la riqueza patrimonial.

### Fundamentos

Existen 3 motivos por el cual se puede demandar dinero:

#### Precaución 

Con el objetivo de poder afrontar un acontecimiento futuro incierto (no se si voy a tener jubilación).
  
#### Transaccional 

Individuos y empresas utilizan dinero para realizar transacciones (el más normal, compra/venta).
  
#### Especulación

Dinero es un depósito de valor que genera demanda de tipo activo financiero, el dinero plenamente líquido es el activo más seguro (ante incertidumbre en el mercado).
...
>La estabilidad de precios de la economía y preservar el valor de la moneda nacional.

Y sus funciones son:

- Llevar a cabo la política monetaria y cambiaria.
- Custodiar y administrar las reservas internacionales (oro y divisas).
- Agente financiero del Gobierno Nacional: prestamista de última instancia.
- Proveer dinero de curso legal.
- Agente regulatorio del sistema bancario y financiero.

## Balance

Refleja las principales cuentas que se derivan de las transacciones realizadas desde sus funciones, se compone del activo y pasivo a través de los cuales se registran las transacciones de la autoridad monetaria (Banco Central).

### Activo

- **Reservas internacionales**: se compone por el stock de activos externos en oro, divisas (moneda) y otros activos.
  
- **Créditos al sistema financiero y/o bancario**: son préstamos del Banco Central a los bancos comerciales, y la **tasa de interés** que se les cobra es un mecanismo directo para controlar la cantidad de dinero que el sistema bancario puede crear, impactando así en la Oferta Monetaria y en el nivel de actividad económica del país.
  
- **Créditos al sector público**: se registra el financiamiento total al sector público en su rol de prestamista de ultima instancia del gobierno y se realiza a través de adelantos transitorios.

### Pasivo

- **Pasivo monetario**: el dinero en efectivo total de la economía, es decir, en poder del público y del sistema bancario, más los activos de caja de los bancos como los requisitos de efectivo mínimo y encaje bancario.
